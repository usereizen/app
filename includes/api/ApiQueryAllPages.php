...
class ApiQueryAllPages extends ApiQueryGeneratorBase {
	...
	public function getExamples() {
		return array(
			...
			'api.php?action=query&generator=allpages&gaplimit=2&gapfilterredir=nonredirects&gapfrom=Re&prop=revisions&rvprop=content' => 'Show content of first 2 non-redirect pages begining at "Re"',
		);
	}
