...
class Title {
	...
	public static function newFromID( $id, $flags = 0 ) {
		// wikia change - return early for common $id = 0 case
		if ( $id == 0 ) {
			return null;
		}
	...
	public function getSquidURLs() {
		...
		if ( $pageLang->hasVariants() ) {
			...
			// Wikia change - @author macbre / BAC-1278
			Hooks::run( 'TitleGetLangVariants', [ $pageLang, &$variants ] );
		...
		// Wikia change - begin
		// @author macbre
		Hooks::run( 'TitleGetSquidURLs', [ $this, &$urls ] );
		// Wikia change - end
	...
	private function moveToInternal( &$nt, $reason = '', $createRedirect = true ) {
		...
		Hooks::run( 'NewRevisionFromEditComplete',
			[ $newpage, $nullRevision, $nullRevision->getParentId(), $wgUser ] );
