...
class Article extends Page {
			...
			switch( $pass ) {
				...
				case 2:
					...
					if ( $useParserCache ) {
						...
						if ( $this->mParserOutput !== false ) {
							...
							Hooks::run('ArticleViewAddParserOutput', [ $this, $this->mParserOutput ] );
							// Wikia change - end
				...
				case 3:
					...
					if ( $this->getTitle()->isCssOrJsPage() || $this->getTitle()->isCssJsSubpage() ) {
						...
						$outputDone = true;
					} elseif( !Hooks::run( 'ArticleViewCustom', array( $this->mContent, $this->getTitle(), $outputPage ) ) ) {
	...
	protected function showCssOrJsPage() {
		...
		if ( Hooks::run( 'ShowRawCssJs', array( $this->mContent, $this->getTitle(), $outputPage ) ) ) {
	...
	public function confirmDelete( $reason ) {
		...
		$checkWatch = (bool)$user->getGlobalPreference( 'watchdeletion' ) || $user->isWatched( $this->getTitle() );
