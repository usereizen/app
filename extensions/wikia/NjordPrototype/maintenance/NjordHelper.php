...
class NjordHelper {
	 ...
	 * @return string
	 */
	public function getOutputFileName( $ext = "csv" ) {
		return 'njord_' . date( "Y_m_d" ) . ".{$ext}";
	}

	public function exportToHTML( $data ) {
	 ...
	 * @return array
	 */
	public function formatOutputRowHTML( $cityId, $data ) {
	 ...
	 * @return array
	 */
	public function formatOutputRowCSV( $cityId, $data, $date_created ) {
		$njordProps = $this->getNjordPropIds();
	 ...
	 * @return mixed
	 */
	public function getWikiaDataById( $cityId ) {
